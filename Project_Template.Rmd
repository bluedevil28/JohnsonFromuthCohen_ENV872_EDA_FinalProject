...
#map income
#ggplot(boston.income.sf2) + geom_sf(aes(fill=estimate)) + geom_sf(data=Bikes.2021.sf2, #aes(color="white", alpha = 0.4))
```
...
```{r display race and bike stations, include=FALSE, eval= FALSE}
Race.legend<-get_legend(Racenw.bikeplot)
Bike_plots <-plot_grid(Racew.bikeplot+theme(legend.position="none"),Racenw.bikeplot+theme(legend.position="none"), nrow=1,align='h')


plot_grid(Bike_plots,Race.legend,nrow=2,rel_heights=c(2,0.5))

```
\newpage
## *Figures 3 and 4* 
```{r data scatterplots prnnwht, echo=FALSE, warning=FALSE}
plot1 <-
  ggplot(bikes.data.join, aes(x=prnnwht, y=NmSttns, color = NmSttns)) +
...
plot2 <-
ggplot(bikes.data.join, aes(x=perwhit, y=NmSttns, color = NmSttns)) +
  geom_point(alpha = 0.9, size = 3) +
  labs(color="Number of Stations")+
  scale_color_viridis(option = "virids", direction = -1) +
  theme(legend.position = "right", 
...
## *Figures 5 and 6*
```{r data scatterplots driv_ln, echo=FALSE, warning=FALSE}
plot3 <-
ggplot(bikes.data.join, aes(x=driv_ln, y=NmSttns, color = NmSttns)) +
  geom_point(alpha = 0.9, size = 3) +
  labs(color="Number of Stations")+
...
plot4 <-
ggplot(bikes.data.join, aes(x=carpool, y=NmSttns, color = NmSttns)) +
  geom_point(alpha = 0.9, size = 3) +
  labs(color="Number of Stations")+
...
plot5 <-
ggplot(bikes.data.join, aes(x=pr_pblc, y=NmSttns, color = NmSttns)) +
  geom_point(alpha = 0.9, size = 3) +
  labs(color="Number of Stations")+
  scale_color_viridis(option = "rocket", direction = -1) +
  theme(legend.position = "right", 
        legend.text = element_text(size = 12), legend.title = element_text(size = 12))+
  labs(title = "Plot of Stations and Means of Transport by Census Tract", subtitle = "People who use Public Transit")+
