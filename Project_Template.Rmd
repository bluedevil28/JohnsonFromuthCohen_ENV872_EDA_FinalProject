...
```{r read and map variables and bike stations, echo= FALSE}
...
Racew.bikeplot <-
  ggplot(boston.race.sf2) + geom_sf(aes(fill=perwhit)) + geom_sf(data=Bikes.2021.sf2, alpha = 0.4, color="orange red") + labs(fill= "Percent White")

#Race and bike stations  (non white)
Racenw.bikeplot <-
ggplot() + geom_sf(data=boston.race.sf2, aes(fill=prnnwht)) + geom_sf(data=Bikes.2021.sf2, alpha = 0.4, color="orange red") + labs(fill= "Percent Non-White")

Bike_plots <-
  plot_grid(Racew.bikeplot+theme(legend.position="none"),Racenw.bikeplot +theme(legend.position="none"))

Bike_plots <-
  plot_grid(Racew.bikeplot,Racenw.bikeplot)

Bike.legend<-get_legend(Racew.bikeplot)
plot_grid(Bike_plots,nrow=2,rel_heights=c(2,0.5))
```


```{r data scatterplots, echo=FALSE, warning=FALSE}

plot1 <-
  ggplot(bikes.data.join, aes(x=pernonwhite, y=NumStations, color = NumStations)) +
...
plot2 <-
ggplot(bikes.data.join, aes(x=perwhite, y=NumStations, color = NumStations)) +
  geom_point(alpha = 0.9, size = 3) +
  labs(color="Number of Stations")+
  scale_color_viridis(option = "virids", direction = -1) +
  theme(legend.position = "right", 
        legend.text = element_text(size = 12), legend.title = element_text(size = 12))+
  xlab("Percent White") +
  ylab("Number of stations") +ylim(0,8) + xlim(0,1)
...
plot3 <-
ggplot(bikes.data.join, aes(x=drive_alone, y=NumStations, color = NumStations)) +
  geom_point(alpha = 0.9, size = 3) +
  labs(color="Number of Stations")+
...
plot4 <-
ggplot(bikes.data.join, aes(x=carpool, y=NumStations, color = NumStations)) +
  geom_point(alpha = 0.9, size = 3) +
  labs(color="Number of Stations")+
...
plot5 <-
ggplot(bikes.data.join, aes(x=per.public, y=NumStations, color = NumStations)) +
  geom_point(alpha = 0.9, size = 3) +
  labs(color="Number of Stations")+
