...
The variables that were significant in our regression of Boston bike stations locations were those who commute to work via public transit, and those who drive to work alone in a private car.  For both variables, the coefficient in the regression was negative: -2.3843 at p = 0.000332 for public transit commuters, and -2.1573 at p = 0.027758 for those who drive to work in cars by themselves.  Our model shows that those living nearer to bike stations are less likely to commute to work either alone in personal vehicles or by public transit.  This finding is the opposite of what we expected: 
