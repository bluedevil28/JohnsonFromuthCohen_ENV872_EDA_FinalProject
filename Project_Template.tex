...
>>>>>>> 5f136287b38aa68af0a67e8356b896ee0850db15
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dataset.column}\FloatTok{.1} \OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"City of Boston"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
<<<<<<< HEAD
United States Census, using the data from the 2015-2019 American
=======
...
<<<<<<< HEAD
relate to transit equity: income and race. The results of this
mapping---which informed our selection of additional variables that
represent parts of the lives of urban families---can be found in the
series of images below.

We removed GEOIDs and neighborhoods that were listed as non-residential
zones, as those areas would confound our analyses relating to
homeownership as well as to commuting patterns.
=======
