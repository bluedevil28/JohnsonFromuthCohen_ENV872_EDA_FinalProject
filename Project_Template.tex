...
\subsection{5.2 Alternate commute modes correlate with Boston bike
station
...
stations locations were those who commute to work via public transit,
and those who drive to work alone in a private car. For both variables,
...
drive to work in cars by themselves. Our model shows that those living
nearer to bike stations are less likely to commute to work either alone
in personal vehicles or by public transit. This finding is the opposite
of what we expected:
